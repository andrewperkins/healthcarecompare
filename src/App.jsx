...
Please provide only the JSON object as your response, with accurate values extracted from the document.`}
      ...
      {showDisclaimerModal && (
        <div className="fixed inset-0 bg-black bg-opacity-75 dark:bg-opacity-85 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col transition-colors" onClick={(e) => e.stopPropagation()}>
            <div className="p-4 sm:p-6 overflow-y-auto flex-1">
              <div className="flex items-center justify-center mb-4">
                <div className="bg-yellow-100 dark:bg-yellow-900/30 p-3 sm:p-4 rounded-full">
                  <Icon name="alert-triangle" size={40} className="text-yellow-600 dark:text-yellow-500" />
                </div>
              </div>
              
              <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100 text-center mb-3">
            ...
            <div className="p-4 sm:p-6 border-t border-gray-200 dark:border-gray-700 flex justify-center bg-white dark:bg-gray-800">
              <button
                onClick={acceptDisclaimer}
                className="bg-indigo-600 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg hover:bg-indigo-700 transition text-base sm:text-lg font-semibold shadow-lg"
              >
                I Understand
              </button>
            </div>
